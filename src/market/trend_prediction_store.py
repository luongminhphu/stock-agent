...
Owner: market segment (Wave E1a — chuyển từ readmodel; prediction là dữ liệu
thị trường do ai.trend_engine_listener ghi, readmodel/briefing/bot chỉ đọc).
...
async def _persist_prediction(session_factory: Any, symbol: str, prediction: Any) -> None:
    ...
    from src.market.models import TrendPrediction
    ...
    await upsert_rows(
        ...
        log_event="trend_prediction_store.persist_failed",
        symbol=symbol,
    )
